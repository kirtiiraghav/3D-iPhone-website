...
export default function Features() {
    ...
    useGSAP(() => {
        ...
        animateWithGsap('#features-title', { opacity: 1, y: 0 },)
    ...
    return (
        <section className='common-padding bg-zinc relative overflow-hidden h-full'>
                ...
                <div className='flex flex-col justify-center items-center overflow-hidden'>
                    ...
                    <div className='flex-center flex-col sm:px-10'>
                        <div className='relative h-[50vh] w-full flex items-center'>
                            <video playsInline muted autoPlay ref={videoRef} preload='none' id='explore-video' className='w-full h-full object-cover object-center'>
                            ...
                            <div className='feature-text-container'>
                                <div className='flex-1 flex-center'>
                                    <p className='feature-text g_text'>iPhone 15 pro is {' '}
                                        <span className='text-white'>the first iPhone to feature an aerospace-grade titanium design using the same alloy that spacecrafts use for missions to Mars.</span>
                                    </p>
                                </div>
